  ...
  return (
    <div className="relative min-h-screen bg-[--background] text-[--foreground]">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,var(--primary)/10,transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,var(--accent)/8,transparent_40%)]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl items-center justify-between gap-12 px-4 py-12 lg:px-8 lg:py-16">
        ...
        <div className="hidden flex-1 space-y-6 lg:block animate-fade-up">
          <p className="text-sm font-semibold uppercase tracking-wider text-[--primary]">{t("registerEyebrow")}</p>
          ...
          <div className="relative mt-8 h-64 w-full overflow-hidden rounded-3xl">
            ...
            <div className="absolute left-8 top-8 h-32 w-32 rounded-2xl bg-[--primary]/10 blur-2xl" />
            <div className="absolute right-8 bottom-8 h-24 w-24 rounded-full bg-[--accent]/10 blur-xl" />
          </div>
        </div>
        ...
        <Card className="w-full max-w-md border-[--border-subtle] bg-[--card]/90 shadow-2xl shadow-black/5 backdrop-blur-sm animate-fade-up" style={{ animationDelay: "0.1s" }}>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-[--text-secondary]">{t("registerCardDescription")}</CardDescription>
          </CardHeader>
          <CardContent>
